...
def radu_tool2():
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f'{toolname} - Made By {owners} - Date : {date_now} - Logged As : {username} | Tokens : {tokens} | https://www.youtube.com/@TysonScripts/about')
    Write.Print(f"""
███████ ██████  ██ ██████  ██ ████████     ████████  ██████   ██████  ██      
██      ██   ██ ██ ██   ██ ██    ██           ██    ██    ██ ██    ██ ██      
███████ ██████  ██ ██████  ██    ██           ██    ██    ██ ██    ██ ██      
...
███████ ██      ██ ██   ██ ██    ██           ██     ██████   ██████  ███████ 
                                          ...
                                          Welcome {username} | https://www.youtube.com/@TysonScripts/about  
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════""", Colors.red_to_blue, interval=0.0000)
    Write.Print(f"\nroot@spiritmultitool ~> ", Colors.red_to_blue, interval=0.000); opc = input(magenta).lower()
    if opc=="x" or opc=="exit" or opc=="esc":
        System.Clear()
        bye_bye(username, date_now)
    if opc=="$":
        Write.Print(f"""
[!] This version is the free version of SpiritTool. To access the Paid Menu, please contact the creator (tysonscripts). \nIf you encounter any issues, you can reach us through our servers or via email.

Discord : tysonscripts (add me)
Email : secret
Github : github.com/leopardfr\n\nroot@press_enter ~> """, Colors.purple_to_red, interval=0.000); input()
        radu_tool2()
    if opc=="+":
        ...
        def update_system():
            def updater():
                    ...
                    if found:
                        ...
                        sys.stdout.flush()
                        Write.Print(f"Download ~> https://github.com/leopardfr" + "\n", Colors.purple_to_red, interval=0.000)
    ...
    if opc=="34":
        ...
        def server_nuker():
            prefix = "!"
            guild_name = "Spirit Runs Discord"
            ...
            async def on_ready():
                System.Clear()
                a = discord.Game(name=f"Spirit Runs Discord", type=3)
...
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
    ...
    if opc=="$":
        Write.Print(f"""
[!] This version is the free version of SpiriitTool. To access the Paid Menu, please contact the creator (tysonscripts). \nIf you encounter any issues, you can reach us through our servers or via email.

Discord : dsc.gg/tysonscripts
Youtube : https://www.youtube.com/@TysonScripts/about
Github : github.com/leopardfr\n\nroot@press_enter ~> """, Colors.purple_to_red, interval=0.000); input()
        radu_tool()
    if opc=="+":
        ctypes.windll.kernel32.SetConsoleTitleW(f'{toolname} - Made By {owners} - Date : {date_now} - Logged As : {username} | Module : Update System')
    ...
    if opc=="1":
        ...
        Write.Print(f"""\n\n
                                    ╔═════════════════════════════════════════╗
                                    ║   Spirit MULTI-TØØL TOKEN CHECKER STATS ║
                                ╔═════════════════════════════════════════════════╗
